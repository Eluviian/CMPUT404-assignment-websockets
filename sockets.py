...
# used for reference: https://github.com/aaronskiba/CMPUT404-assignment-websockets/blob/master/sockets.py
...
#taken directly from aaronskiba repo
def send_all(msg):
...
def read_ws(ws,client):
    ...
    data = ws.receive()
    print("READ_WS")
    while data: #keep reading until we run out of data
...
def subscribe_socket(ws):
    ...
    try:
        ...
        print("ERROR IN SUBSCRIBE_SOCKET:",e)
    finally:
...
def update(entity):
    ...
    return Response(json.dumps(entity), status=200)
